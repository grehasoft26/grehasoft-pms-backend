...
export class TasksController {
  ...
  @ApiOperation({
    summary:
      'Get specific task details (with subtasks tree, comments, and checklists)',
  })
  @ApiResponse({ type: SuccessResponseDto })
  ...
  @ApiOperation({
    summary: 'Update task properties, story points, or estimated hours',
  })
  @ApiResponse({ type: SuccessResponseDto })
  async update(
    @Param('id') id: string,
  ...
  @Permissions('tasks.update')
  @ApiOperation({
    summary: 'Update Kanban status and sort position (Drag-and-Drop)',
  })
  @ApiResponse({ type: SuccessResponseDto })
  async updatePosition(
    ...
    const context = this.getContext(req);
    const data = await this.tasksService.updatePosition(
      id,
      dto.statusId,
      dto.position,
      context,
  ...
  @ApiOperation({
    summary: 'Permanently hard delete a task (Super Admin only)',
  })
  @ApiResponse({ type: SuccessResponseDto })
