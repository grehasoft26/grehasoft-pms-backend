...
export class EmployeesController {
  ...
  @ApiOperation({
    summary: 'Onboard a new employee profile (generates EMP-YYYY-000001 code)',
  })
  ...
  @ApiOperation({
    summary:
      'Update employee profile (e.g. status changes, manager, division, payroll fields)',
  })
  @ApiResponse({ type: SuccessResponseDto })
  ...
  @ApiOperation({
    summary:
      'Attach a document category (Offer Letter, Contract, PAN, Aadhaar, etc.)',
  })
  @ApiResponse({ type: SuccessResponseDto })
  ...
  @Permissions('hr.read')
  @ApiOperation({
    summary: 'Get employee details with skills, documents, and shift history',
  })
  @ApiResponse({ type: SuccessResponseDto })
  ...
  @ApiOperation({
    summary:
      'Get employee promotion, department changes, transfer timeline events',
  })
  @ApiResponse({ type: SuccessResponseDto })
