...
export class CreateProjectDocumentDto {
  ...
  @ApiProperty({ description: 'File key pointing to local/remote storage file location' })
  @IsNotEmpty()
  @IsString()
  fileKey: string;

  @ApiProperty({ enum: ProjectDocumentCategory, default: ProjectDocumentCategory.OTHER })
  @IsNotEmpty()
